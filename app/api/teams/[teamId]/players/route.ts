          ...
          >
            ...
            <div className="mt-5 rounded-xl border border-yellow-400/20 bg-yellow-400/[0.06] p-4">
              ...
              <p className="mt-1 text-xs leading-5 text-zinc-400">
                If this player previously participated in matches,
                setting them to Inactive is the safer choice for
                preserving their historical roster record.
              </p>
            </div>
